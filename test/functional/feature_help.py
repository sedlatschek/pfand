...
"""Verify that starting pfandcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start pfandcoin with -h for help text")
        ...
        self.log.info("Start pfandcoin with -version for version information")
        ...
        self.log.info("Start pfandcoind with -fakearg to make sure it does not start")
