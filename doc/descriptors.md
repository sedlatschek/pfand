# Support for Output Descriptors in Pfandcoin Core

Since Pfandcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Pfandcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Pfandcoin Core wallets, a convenience function `combo` is
