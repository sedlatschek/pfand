...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1621084947, 2084524493, 0x1e0ffff0, 1, 50 * COIN);
        ...
        vSeeds.emplace_back("seed-a.pfandcoin.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.pfandcointools.com");
        vSeeds.emplace_back("dnsseed.pfandcoinpool.org");
