...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " pfandcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  pfandcoin-tx [options] <hex-tx> [commands]  Update hex-encoded pfandcoin transaction\n" +
            "or:     pfandcoin-tx [options] -create [commands]   Create hex-encoded pfandcoin transaction\n" +
            "\n";
